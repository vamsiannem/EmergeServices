...
<body>
    ...
    <div class="bodyContent">
        <div class="contentHeader">
            <span>View All Customer Segments</span>
            <a onclick="window.location.href='/EmergeServices/org/addSegment'" class="styledButton actionButtons">Add New Customer Segment</a>
        </div>
